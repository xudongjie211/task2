            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    <div class="clearfix">
                        ...
                        <div class="text">
                            <h4 class="">${courses[0].coursename}</h4>
                            <p class="text-present">${courses[0].intro}</p>
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="rightWarp">
                            <div class="rightWarp-class">
                                ...
                                <div class="rightWarp-wages">${courses[0].salary}/月</div>
                            </div>
                            <div class="rightWarp-class">
                                <div class="rightWarp-year">0-1年</div>
                                <div class="rightWarp-wages">${courses[0].salary}/月</div>
                    ...
                    <div class="warp-class2">
                        <b class="text-b">有${courses[0].studynum}人正在学</b>
                    </div>
                    <div class="warp-class2">
                        <p class="text-p"><font color="red">在学人数:${courses[0].studynum}  更新时间：<out:date name="${courses[0].create_at}"></out:date></font></p>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    <div class="clearfix">
                        <div class="icon-people"><img src="imges/687.png"></div>
                        <div class="text">
                            <h4 class="">${courses[1].coursename}</h4>
                            <p class="text-present">${courses[1].intro}</p>
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="rightWarp">
                            <div class="rightWarp-class">
                                <div class="rightWarp-year">0-1年</div>
                                <div class="rightWarp-wages">${courses[1].salary}/月</div>
                            </div>
                            <div class="rightWarp-class">
                                <div class="rightWarp-year">0-1年</div>
                                <div class="rightWarp-wages">${courses[1].salary}/月</div>
                    ...
                    <div class="warp-class2">
                        <b class="text-b">${courses[1].studynum}</b>
                    </div>
                    <div class="warp-class2">
                        <p class="text-p"><font color="red">在学人数:${courses[1].studynum}  更新时间：<out:date name="${courses[1].create_at}"></out:date></font></p>
                    </div>
